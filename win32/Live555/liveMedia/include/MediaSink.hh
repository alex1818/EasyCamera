...
public:
  ...
  void SetOnDarwinClosure(afterPlayingFunc* afterFunc,
				void* afterClientData);
...
protected:
  ...
  static void onDarwinClosure(void* clientData);
...
private:
  ...
  afterPlayingFunc* fAfterDarwinFunc;
  void* fAfterDarwinClientData;
